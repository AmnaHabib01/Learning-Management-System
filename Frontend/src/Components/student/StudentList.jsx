...
// import { Loader2, RefreshCcw, Info, Edit2, Trash2, User } from "lucide-react";
// import useStudentStore from "../../store/student/useStudentStore";
// import Toast from "../ui/Toast";

// export default function StudentList({ onEditStudent, onShowDetail, onDeleteStudent }) {
...
//     student.profileImageUrl || "https://cdn-icons-png.flaticon.com/512/3135/3135715.png";
...
//           <h2 className="text-2xl font-extrabold text-blue-900">All Registered Students</h2>
//           <button
...
//         {error && (
//           <div className="p-4 mb-4 bg-red-100 text-red-800 rounded-lg font-medium border border-red-200">
//             {error}
//           </div>
//         )}
...
//             <p className="text-lg text-blue-900 font-medium">Loading student data...</p>
//           </div>
//         ) : (
...
//                   <tr key={student._id} className="hover:bg-yellow-50 transition-colors">
...
//                           student.studentIsVerified ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"
//                         }`}
//                       >
...
//             <p className="mb-6">Do you really want to delete {studentToDelete.name}?</p>
...
//                     setToastMessage({ message: `${studentToDelete.name} deleted successfully`, type: "success" });
//                   } catch (err) {
...
import React, { useEffect, useState } from "react";
import { Loader2, RefreshCcw, User, Edit2, Trash2 } from "lucide-react";
import useStudentStore from "../../store/student/useStudentStore";
import Toast from "../ui/Toast";

export default function StudentList({ onEditStudent, onShowDetail }) {
